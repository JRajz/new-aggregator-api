...
describe("Get User Accessible News by search", () => {
  let accessToken;
  ...
  it("Search news succesfully", (done) => {
    let keyword = "VPN";
    chai
      .request(server)
      ...
      .end((err, res) => {
        ...
        expect(res.body.error).equal(false);
        expect(res.body).to.have.own.property("data");
        expect(res.body.message).equal("News found");
        done();
      });
  });

  it("New not found for keyword", (done) => {
    let keyword = "VPNA";
    chai
      .request(server)
      .get(`/news/search/${keyword}`)
      ...
      .end((err, res) => {
        ...
        expect(res.body.message).equal("No news found");
        done();
      });
  });

  it("Invalid keyword", (done) => {
    let keyword = "VPN-";
    chai
      .request(server)
      .get(`/news/search/${keyword}`)
      ...
      .end((err, res) => {
        ...
        expect(res.body).to.not.have.own.property("data");
...
// Write Testcases for read and favourite news during mongodb
